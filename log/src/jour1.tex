...
\begin{figure}
  \input{../figures/f_and_h_funcs_monopole.tex}
...
\begin{subsection}{Effects of the parameters}
  ...
  \begin{figure}
    \begin{center}
      \input{../figures/varying_vacuum_f.tex}
      \input{../figures/varying_vacuum_h.tex}
  ...
  \begin{figure}
    \begin{center}
      \input{../figures/varying_vacuum_energy.tex}
  ...
  \begin{figure}
    \begin{center}
      \input{../figures/varying_lambda_f.tex}
      \input{../figures/varying_lambda_h.tex}
  ...
  \begin{figure}
    \begin{center}
      \input{../figures/varying_lambda_energy.tex}
      \caption{\em Dependence of the energy with respect to the Higgs
        field interaction constant $\lambda$, with $g=1$, $v = 1$}
